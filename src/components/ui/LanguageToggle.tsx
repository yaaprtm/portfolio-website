...
export default function LanguageToggle() {
  ...
  return (
    <button
      ...
      className="relative h-8 rounded-full border border-mono-border bg-white/[0.02] flex items-center
                 font-mono text-[11px] font-bold overflow-hidden transition-all hover:border-mono-black
                 px-1 gap-0.5"
      title={lang === "id" ? "Switch to English" : "Ganti ke Bahasa Indonesia"}
      aria-label="Toggle language"
    >
      <LangOption code="ID" active={lang === "id"} />
      <span className="text-mono-muted text-[9px] mx-0.5">/</span>
