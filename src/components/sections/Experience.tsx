    ...
    >
      ...
      <div className="relative flex flex-col items-center">
        <div className="w-12 h-12 rounded-full bg-olive-500/10 border border-olive-500/20 flex items-center justify-center flex-shrink-0 z-10">
          <Icon size={20} className="text-olive-500" />
        </div>
      ...
      <div className="flex-1 editorial-card p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 mb-4">
          <div>
            <h3 className="font-display font-extrabold text-warm-dark text-xl">{exp.title}</h3>
            <p className="text-warm-gray text-xs font-semibold uppercase tracking-wider mt-1">
          ...
          <div className="flex flex-wrap items-center gap-2 flex-shrink-0">
            ...
            <span className="text-xs font-bold uppercase tracking-wider text-white bg-olive-500 px-3.5 py-1.5 rounded-full">
              {config.label}
            </span>
          </div>
        </div>
...
export default function Experience() {
  ...
  return (
    <SectionWrapper id="experience" className="bg-[#F0EEE9]">
      <SectionHeading
