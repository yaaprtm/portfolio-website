        ...
        <main className="max-w-[210mm] mx-auto bg-white p-8 print:p-[15mm] my-6 print:my-0 shadow-lg print:shadow-none">
          ...
          <section className="mb-4 break-inside-avoid">
            ...
            <p className="text-xs text-gray-800 leading-relaxed" style={{ fontFamily: 'Arial, sans-serif' }}>
              {lang === "id"
                ? "IT Enthusiast dan mahasiswa D4 Teknik Rekayasa Internet di Politeknik Elektronika Negeri Surabaya (PENS) dengan pengalaman di Networking, IT Support, dan Android Development. Pernah magang sebagai Android Developer di BRIN dan menangani proyek instalasi VSAT di Kalimantan Barat. Bersertifikasi MikroTik MTCNA (88%)."
                : "IT Enthusiast and D4 Internet Engineering student at Politeknik Elektronika Negeri Surabaya (PENS) with experience in Networking, IT Support, and Android Development. Completed an internship as an Android Developer at BRIN and managed VSAT installation projects in West Kalimantan. MikroTik MTCNA certified (88%)."}
            </p>
          </section>
